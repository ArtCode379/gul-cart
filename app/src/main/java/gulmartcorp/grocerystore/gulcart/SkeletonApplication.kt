...
import gulmartcorp.grocerystore.gulcart.di.dataModule
import gulmartcorp.grocerystore.gulcart.di.dispatcherModule
import gulmartcorp.grocerystore.gulcart.di.viewModule
...
class AHSQYApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@AHSQYApplication)
            modules(appModules)
        }
